...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                 ...
                 * "/api/clientes/upload").hasAnyAuthority("USER", "ADMIN")
                 * .antMatchers(HttpMethod.POST,
                 * "/api/clientes").hasRole("ADMIN").antMatchers("/api/clientes/**")
                 * .hasRole("ADMIN")
                 */
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configCors.setAllowedMethods(Arrays.asList("GET", "POST", "DELETE", "OPTIONS"));
    ...
    public FilterRegistrationBean<CorsFilter> corsFilter() {
        FilterRegistrationBean<CorsFilter> fBean = new FilterRegistrationBean<CorsFilter>(
